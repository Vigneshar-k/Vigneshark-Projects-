...
void on_calculate_total_bill_clicked(GtkButton *button, gpointer user_data) {
    int total = 0;
    for (int i = 0; i < user_cart.num_items; i++) {
...
int main(int argc, char *argv[]) {
    ...
    g_signal_connect(show_preference_button, "clicked", G_CALLBACK(on_show_preference_clicked), NULL);
    ...
    g_signal_connect(sort_by_distance_button, "clicked", G_CALLBACK(on_sort_by_distance_clicked), NULL);
    ...
    g_signal_connect(sort_by_discount_button, "clicked", G_CALLBACK(on_sort_by_discount_clicked), NULL);
    ...
    g_signal_connect(total_bill_button, "clicked", G_CALLBACK(on_calculate_total_bill_clicked), NULL);
